  ...
  const initialFormData = (): LearnerFormData => {
    if (editingLearner) {
      return {
        ...
        reasonForNotAttendingOther: editingLearner.reasonForNotAttendingOther || '',
        isBlp: editingLearner.isBlp ? 'Yes' : 'No',
        occupationType: editingLearner.occupationType || '',
        employmentStatus: editingLearner.employmentStatus || '',
        monthlyIncome: editingLearner.monthlyIncome || '',
        interestedInALS: editingLearner.interestedInALS || '',
        contactNumber: editingLearner.contactNumber || '',
